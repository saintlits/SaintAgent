...
impl SettingsWidget for CLIAgentWidget {
    ...
    fn search_terms(&self) -> &str {
        "third party cli coding agent claude codex gemini genericagent ga toolbar footer layout chip chips rearrange re-arrange bar command regex auto show rich input dismiss"
    }
    ...
    fn render(
        ...
        let description_fragments = vec![
            ...
            FormattedTextFragment::plain_text(", or "),
            FormattedTextFragment::inline_code("ga"),
            FormattedTextFragment::plain_text("."),
        ];
