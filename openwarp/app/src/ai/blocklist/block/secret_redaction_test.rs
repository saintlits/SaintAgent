...
fn test_detect_secrets_multiple_secrets() {
    ...
    let text = "ABCD ghp_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX foo baz warp-server-staging.firebaseapp.com bar \n foo sk_test_aaaaaaaaaaaaaaaaaaaaaaaa qux foo";
    let detected_secrets = find_secrets_in_text(text);
    assert_eq!(
        detected_secrets,
        vec![
...
fn test_detect_secrets_default_regex_case_sensitivity() {
    ...
    let text = "API keys: sk_test_aaaaaaaaaaaaaaaaaaaaaaaa SK_TEST_ABCDEF123456789012345678";
    let detected_secrets = find_secrets_in_text(text);
    assert_eq!(
        detected_secrets,
        vec![SecretRange {
    ...
    let text = "API keys: sk_test_aaaaaaaaaaaaaaaaaaaaaaaa sk_test_aaaaaaaaaaaaaaaaaaaaaaaa";
    let detected_secrets = find_secrets_in_text(text);
    assert_eq!(
        detected_secrets,
        vec![
