...
fn test_stripe_api_key() {
    let stripe_api_key = "sk_test_aaaaaaaaaaaaaaaaaaaaaaaa";
    let stripe_restricted_api_key = "rk_test_aaaaaaaaaaaaaaaaaaaaaaaa";
    let stripe_api_test_key = "sk_test_aaaaaaaaaaaaaaaaaaaaaaaa";
...
fn test_github_tokens() {
    let classic_personal_token = "ghp_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    let fine_grained_personal_access_token = "github_pat_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    let gh_oauth_token = "gho_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
...
fn test_google_api_key() {
    let google_api_key = "AIzaSyAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
